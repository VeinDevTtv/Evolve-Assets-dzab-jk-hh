...
-- Get LVC beta version from github
  ...
  -- Get repo version for installed plugins
	...
	print('\t|\t  EEEEEEEEEEEE     V       V     OOOOOOO    L           V       V    EEEEEEEEEE    |')
	print('\t|\t  EEE              V       V    O       O   L           V       V    EEE            |')
	print('\t|\t  EEE              V       V    O       O   L           V       V    EEE            |')
	print('\t|\t  EEE              V       V    O       O   L           V       V    EEE            |')
	print('\t|\t  EEEEEEEE         V       V    O       O   L           V       V    EEEEEEEE       |')
	print('\t|\t  EEE               V     V     O       O   L            V     V     EEE            |')
	print('\t|\t  EEE               V     V     O       O   L            V     V     EEE            |')
	print('\t|\t  EEEEEEEEEEEE        VVV       OOOOOOO    LLLLLLLLL        VVV       EEEEEEEEEE    |')
	print('\t|                                                                  |')
